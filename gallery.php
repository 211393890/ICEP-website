  ...
  <br/><br/>
    ...
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-md-4 ">
          <div class="grid mask">
            <figure> <img class="img-responsive img-thumbnail" src="assets/img/portfolio/folio01.jpg" alt="">
              <figcaption>
                <h5>ICEP gallery</h5>
        ...
        <div class="col-md-4">
          <div class="grid mask">
            <figure> <img class="img-responsive img-thumbnail" src="assets/img/portfolio/folio02.jpg" alt="">
              <figcaption>
                <h5>ICEP gallery</h5>
        ...
        <div class="col-md-4">
          <div class="grid mask">
            <figure> <img class="img-responsive img-thumbnail" src="assets/img/portfolio/folio03.jpg" alt="">
              <figcaption>
                <h5>ICEP gallery</h5>
      ...
      <div class="row">
        <div class="col-md-4 ">
          <div class="grid mask">
            <figure> <img class="img-responsive img-thumbnail" src="assets/img/portfolio/folio04.jpg" alt="">
              <figcaption>
                <h5>ICEP gallery</h5>
        ...
        <div class="col-md-4">
          <div class="grid mask">
            <figure> <img class="img-responsive img-thumbnail" src="assets/img/portfolio/folio05.jpg" alt="">
              <figcaption>
                <h5>ICEP gallery</h5>
        ...
        <div class="col-md-4">
          <div class="grid mask">
            <figure> <img class="img-responsive img-thumbnail" src="assets/img/portfolio/folio06.jpg" alt="">
              <figcaption>
                <h5>ICEP gallery</h5>
      ...
      <div class="row">
        <div class="col-md-4 ">
          <div class="grid mask">
            <figure> <img class="img-responsive img-thumbnail" src="assets/img/portfolio/folio07.jpg" alt="">
              <figcaption>
                <h5>ICEP gallery</h5>
