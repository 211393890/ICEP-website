    ...
    <div class="container">
	  ...
	  <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
		  ...
		  <li> <a href="admin.do?select=activation">Activation</a></li>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="panel panel-default">
				   ...
				   <%
				      Member allSignedUp =(Member)request.getAttribute("MemberObject");
					  Education education = (Education)session.getAttribute("EducationObject");
				   %>

						<h3 class="panel-title"><%=allSignedUp.getName()%></h3>
					</div>
					<div class="panel-body">
						...
						<h5><%=education.getInstitution()%></h5>
						<h5><%=education.getQualification()%></h5>
