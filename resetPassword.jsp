	...
	<div class= "modal fade"  id="popUpWindow">
        <div class= "modal-dialog">
            <div class ="modal-content">
				...
				<h5><a href="#" >Forgot password?</a><a href="signUp.html" >Sign Up?</a></h5>
  ...
  <div class="container">
    <div class="row">
	  ...
	  <h2 class ="centered">Reset password</h2>
			...
			<form  name="data" action="login.do" method="POST"  class="form" role="form"  >
			
			  <%@ page import = "za.ac.icep.login.Login"%>
			  
			  <%
                 Login login =(Login)request.getAttribute("loginObject");
					  
					 if(login != null)
					 { 			  
			  %>
						<input name="studnum" value="<%=login.getStudentNum()%>" type="hidden" />
					
				<div class="row">
					<div class="col-xs-6 col-md-3" id>
						<h4>Security queastion</h4>
					</div>
					
					<div class="col-xs-6 col-md-6">
						<input class="form-control" id="name" name="Name" value="<%=login.getPasswordQuestion()%>" placeholder="" type="text" required />
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-xs-6 col-md-6">
						<input class="form-control" id="name" name="securityAnswer"  type="text" required />
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-xs-6 col-md-6">
						<input class="form-control" id="name" name="Name" placeholder="" type="password" required />
					</div>
				</div>
				...
				<div class="row" >
					<div class="col-xs-12 col-md-12">
						<button class="btn btn btn-lg" type="submit" name="select"  value="Reset">Submit</button>
					</div>
				</div>
