<%@ page import = "java.util.Vector,za.ac.icep.member.Member,za.ac.icep.login.Login"%>
  <%
	Member member = (Member)session.getAttribute("MemberObject");
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
					  <form name="data" action="signUp.do" method="POST"  class="form" role="form">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">Edit personal details</h3>
							</div>
							...
							<div class="panel-body">
								...
								<div class="row">
									...
									<div class="col-xs-6 col-md-9">
										<input class="form-control" id="name" name="name"  value="<%=member.getName()%>" type="text" required />
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-xs-6 col-md-9">
										<input class="form-control" id="name" name="surname" value="<%=member.getSurname()%>" type="text" required />
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-xs-6 col-md-9">
										<input class="form-control" id="name" name="email" value="<%=member.getEmail()%>" type="text" required />
									</div>
								</div>
                                <input  type="hidden" name="memberid" value="<%=member.getMemberId()%>"/>
								<button class="btn btn btn-lg" type="submit" name="select"  value="updatePersonal" onClick = "return val();" >Submit</button>
							</div>
						</div>
						</form>
					</div>
