...
<div id="contact" name="contact">
  <div class="container">
    <div class="row">
	  ...
	  <h2 class ="centered">Quotation</h2>
			
			<form  name="data" action="signUp.do" method="POST"  class="form" role="form" name="frm" >
				...
				<div class="row">
					...
					<div class="col-xs-6 col-md-6">
						<select class ="form-control" id ="name" name="gender" type ="checkbox" required >
						    <option></option>
