				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<h5>Name	: Frank</h5>
								<h5>Surname	: Mogale</h5>
								<h5>E-mail	: phetana.mogale@gmail.com</h5>

								<button class="btn btn btn-lg" type="submit" name="select"  value="Sign Up" onClick = "return val();" >Edit</button>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<h5>Qualification	: National Diploma in Information Technology</h5>
								<h5>Institution		: Tshwane University of Technology</h5>
								<h5>Year		: 2015</h5>
