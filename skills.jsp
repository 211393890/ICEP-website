 <%@ page import = "java.util.Vector,za.ac.icep.member.Member,za.ac.icep.job.Job,za.ac.icep.education.Education"%>
  <%
	Job job = (Job)session.getAttribute("JobObject");
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
					  <form name="data" action="signUp.do" method="POST"  class="form" role="form">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">Edit Current Job</h3>
							</div>
							...
							<div class="panel-body">
								<div class="row">
									...
									<div class="col-xs-6 col-md-9">
										<input class="form-control" id="name" name="companyName"  value="<%=job.getCompanyName()%>" type="text" required />
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-xs-6 col-md-9">
										<input class="form-control" id="name" name="startDate" value="<%=job.getStartDate()%>" type="text" required />
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-xs-6 col-md-9">
										<input class="form-control" id="name" name="position" value="<%=job.getPosition()%>" type="text" required />
									</div>
								</div>
                                <input  type="hidden" name="memberid" value="<%=job.getMemberId()%>"/>
								<button class="btn btn btn-lg" type="submit" name="select"  value="updateSkills" onClick = "return val();" >Submit</button>
							</div>
						</div>
						</form>
					</div>
