    ...
    <div class="container">
	  ...
	  <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li> <a href="projectsphp" class="smoothScroll"> Projects</a></li>
                ...
                <div class= "modal-body">
                    <form action="<?php echo $_SERVER['PHP_SELF'] ;?>" method="POST">
                        <div class="form-group">
                            <input type="text" class= "form-control" name="studentNum" placeholder="Enter student number">
						</div>
						...
						<button class="btn btn-primary btn-block"  name="login" value="login">Log In</button>
					</form>
				</div>
...
<div class= "backround-wrap">
		<video  id = "video-bg-elem" preload ="auto" autoplay = "true" loop ="loop" muted ="muted">
			<source src= "assets/video/icep.mp4" type="video/mp4" >
		</video>
