  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 centered"> <i class="fa fa-map-marker fa-2x"></i>
        <p>07 Aubrey Matlala Road<br>
          Soshanguve Block L</p>
      </div>
      <div class="col-md-4"> <i class="fa fa-envelope-o fa-2x"></i>
        <p>phurutsimb@tut.ac.za</p>
      </div>
    ...
    <div class="row">
      <div class="col-lg-8 col-lg-offset-2 centered">
        <p>For any inquiries, drop an email in the link below. Members at ICEP would love to hear from you.</p>
